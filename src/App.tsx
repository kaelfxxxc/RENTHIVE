...
export default function App() {
  return (
    <BrowserRouter>
      <AuthProvider>
        {/* Platform settings (fees, limits, feature flags) are read from the
            database and needed by both public and authenticated pages. */}
        <SettingsProvider>
          <ToastProvider>
            <Routes>
              {/* Public */}
              ...
              <Route path="/admin/notifications" element={<ProtectedRoute allowedRoles={["admin"]}><NotificationsPage layout={AdminLayout} /></ProtectedRoute>} />
